...
#include "absl_debugging_symbolize.hpp"
...
// MARK: - BEGIN absl_debugging_symbolize_elf.inc
// Copyright 2018 The Abseil Authors.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
...
#include <CppAbseil/absl_base_internal_low_level_alloc.hpp>
#include <CppAbseil/absl_base_internal_raw_logging.hpp>
#include <CppAbseil/absl_base_internal_spinlock.hpp>
#include <CppAbseil/absl_base_port.hpp>
#include <CppAbseil/absl_debugging_internal_demangle.hpp>
#include <CppAbseil/absl_debugging_internal_vdso_support.hpp>
...
// MARK: - END absl_debugging_symbolize_elf.inc

#elif defined(ABSL_INTERNAL_HAVE_SYMBOLIZE_WIN32)
// The Windows Symbolizer only works if PDB files containing the debug info
// are available to the program at runtime.

// MARK: - BEGIN absl_debugging_symbolize_win32.inc
// Copyright 2018 The Abseil Authors.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
...
// MARK: - END absl_debugging_symbolize_win32.inc

#elif defined(__APPLE__)

// MARK: - BEGIN absl_debugging_symbolize_darwin.inc
...
// MARK: - END absl_debugging_symbolize_darwin.inc

#elif defined(ABSL_INTERNAL_HAVE_SYMBOLIZE_WASM)

// MARK: - BEGIN absl_debugging_symbolize_emscripten.inc
// Copyright 2020 The Abseil Authors.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
...
// MARK: - END absl_debugging_symbolize_emscripten.inc

#else

// MARK: - BEGIN absl_debugging_symbolize_unimplemented.inc
// Copyright 2018 The Abseil Authors.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
...
// MARK: - END absl_debugging_symbolize_unimplemented.inc
