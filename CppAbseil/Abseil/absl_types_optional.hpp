...
#include <CppAbseil/absl_types_bad_optional_access.hpp>
#include <CppAbseil/absl_types_internal_optional.hpp>
...
// nullopt_t
//
// Class type for `absl::nullopt` used to indicate an `std::optional<T>` type
...
// Example:
//
//   constexpr std::optional<int> opt = absl::make_optional(1);
...
struct hash<std::optional<T> >
    : std::optional_internal::optional_hash_base<T> {};
